 ...
 * Name: Emma
 * Course: Sofware Devlopment
 * Teacher: Mister Hardman
...
public class PlayField extends World
{
    ...
    /**
     * Creating the thing PlayFeild uses to prep the world
     * Sets background colour 
     * Adds paddles and center line
     * Adds starting text
     */
    private void initializePlayingField()
    {
        ...
        showText("Press the space bar to begin game", 200, 550);
    }
    ...
    /**
     * Adding ball and players to the world in the right locations
     */
     ...
     * If not it checks to see if the space bar has been pressed 
     * If so it checks to see if a player has won
     */
    public void act()
    {
        if(startGame == false)
     ...
     * If pressed starts the game
     * Removes text
     * Sets velocity of theBall to 5 pixeles 
     */
    ...
    /**
     * adds theBall to the world in the center
     * If the game starts it starts moving 
     */
    public void reset()
    {
        theBall = new Ball();
     ...
     * Once a player wins it displays a winning text
     */
    private void checkWin()
    {
        GreenfootImage player1Win = new GreenfootImage("Player 1 Wins", 45, Color.RED, Color.BLACK);
        GreenfootImage player2Win = new GreenfootImage("Player 2 Wins", 45, Color.YELLOW, Color.BLACK);
